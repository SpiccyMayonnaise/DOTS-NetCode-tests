...
{
    [BurstCompile]
    public struct MovableCubeGhostComponentSerializer
    {
        static MovableCubeGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<MovableCube>(),
                ComponentSize = UnsafeUtility.SizeOf<MovableCube>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<MovableCube>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<MovableCube>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<MovableCube>(backupData, 0);
